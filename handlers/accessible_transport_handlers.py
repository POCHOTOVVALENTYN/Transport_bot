    ...
    if not routes:
        ...
        if route_titles:
            ...
            for route_num in route_titles:
                # Нормалізуємо номер маршруту (на всяк випадок)
            ...
            if found_vehicles_count > 0:
                ...
                message = (
                    ...
                    f"───────────────\n\n"
                    f"😔 Прогноз прибуття на цю зупинку наразі відсутній (можливо, вагон рухається в інший бік).\n\n"
                    f"🔎 <b>Але я знайшов {found_vehicles_count} низькопідлогових вагонів на лінії:</b>"
                    f"{monitoring_text}\n"
                    f"➖➖➖➖➖➖➖\n"
                    f"💡 <i>Щоб зрозуміти напрямок руху, перегляньте карту.</i>"
                )
            else:
                ...
                message = (
                    f"♿️ <b>На зупинці '{stop_title}'</b> 🚏\n"
                    f"───────────────\n\n"
                    f"🤔 <b>На жаль, зараз немає інформації.</b>...</b>\n\n"
